              ...
              children: [
                ...
                ListTile(
                  title: TextFormField(
                    ...
                    onChanged: (newVal) {
                      bloc.add(EmployeeLikeChangedEvent(newVal));
                    },
                  )
                ),
                ListTile(
                  leading: Checkbox(
                    ...
                    onChanged: (newVal) {
                      bloc.add(EmployeeFilterGenderEvent(newVal!, 'm'));
                    }
                  ),
                  title: Text(l.gen('m'))
                ),
                ListTile(
                  leading: Checkbox(
                    ...
                    onChanged: (newVal) {
                      bloc.add(EmployeeFilterGenderEvent(newVal!, 'f'));
                    }
                  ),
                  title: Text(l.gen('f'))
                ),
                ...
                for (int i = 0; i < bloc.roles.length; i++) ListTile(
                  leading: Checkbox(
                    ...
                    onChanged: (newVal) {
                      bloc.add(EmployeeRoleSelectedEvent(i, newVal!));
                    },
                  ),
